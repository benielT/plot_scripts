...
ax.plot(xticks, cgen_b1_u280_datcopy, linestyle='-', marker='d', markersize=throughput_marker_size, label='c_1B_CP', color=colors[8])
ax.plot(xticks, cgen_b10_u280_datcopy, linestyle='-', marker='d', markersize=throughput_marker_size, label='c_10B_CP', color=colors[9])
ax.plot(xticks, cgen_b20_u280_datcopy, linestyle='-', marker='d', markersize=throughput_marker_size, label='c_20B_CP', color=colors[10])
ax.plot(xticks, cgen_b50_u280_datcopy, linestyle='-', marker='d', markersize=throughput_marker_size, label='c_50B_CP', color=colors[11])
ax.plot(xticks, cgen_b100_u280_datcopy, linestyle='-', marker='d', markersize=throughput_marker_size, label='c_100B_CP', color=colors[12])
...
ax.plot(xticks, cgen_wo_batching_u280, linestyle='-', marker='o', markersize=throughput_marker_size, label='c_WOB_LB', color=colors[1])
ax.plot(xticks, h100_1b, linestyle='-', marker='^', markersize=throughput_marker_size, label='H100_1B', color=colors[14])
ax.plot(xticks, h100_50b, linestyle='-', marker='^', markersize=throughput_marker_size, label='h100_50b', color=colors[15])
