...
# Load data
batched_df = pd.read_csv("data/Laplace2D5pt_throughput.csv")
df = pd.read_csv("../../ops_fpga/throughput_performance_comparision/data/Laplace2D5pt_throughput.csv")
...
# Save the figure
fig.tight_layout()
plt.savefig("output/laplace2d5pt_batched_throughput_lineplot.pdf", bbox_inches='tight')
# plt.show()
