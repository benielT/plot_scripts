...
# Load data
batched_df = pd.read_csv("data/Jacobi3D7pt_throughput_u280.csv")
batched_df_vck5000 = pd.read_csv("data/Jacobi3D7pt_throughput_vck5000.csv")
df = pd.read_csv("../../ops_fpga/throughput_performance_comparision/data/Jac3D7pt_throughput.csv")

# Extract data from CSV
xticks = df["grid_size"][:-4].astype(str)
cgen_b1_u280_datcopy = batched_df["cgen_DATCPY_1B"][:-4]
cgen_b10_u280_datcopy = batched_df["cgen_DATCPY_10B"][:-4]
cgen_b50_u280_datcopy = batched_df["cgen_DATCPY_50B"][:-4]

cgen_b1_vck5000_datcopy = batched_df_vck5000["cgen_DATCPY_1B"][:-4]
cgen_b10_vck5000_datcopy = batched_df_vck5000["cgen_DATCPY_10B"][:-4]
cgen_b50_vck5000_datcopy = batched_df_vck5000["cgen_DATCPY_50B"][:-4]
...
# h100_1b = df["H100_1B"][:-4]
# h100_50b = df["H100_50B"][:-4]
...
cgen_b1_u280_datcopy_pow = batched_df["cgen_DATCPY_1B_1000B_pow"][:-4]
cgen_b10_u280_datcopy_pow = batched_df["cgen_DATCPY_10B_1000B_pow"][:-4]
cgen_b50_u280_datcopy_pow = batched_df["cgen_DATCPY_50B_1000B_pow"][:-4]


cgen_b1_vck5000_datcopy_pow = batched_df_vck5000["cgen_DATCPY_1B_1000B_pow"][:-4]
cgen_b10_vck5000_datcopy_pow = batched_df_vck5000["cgen_DATCPY_10B_1000B_pow"][:-4]
cgen_b50_vck5000_datcopy_pow = batched_df_vck5000["cgen_DATCPY_50B_1000B_pow"][:-4]
...
geometric_means = {
    'U280 without batching energy': geometric_mean(cgen_b1_u280_datcopy_pow),
    'U280 datacopy 50B energy': geometric_mean(cgen_b50_u280_datcopy_pow),
    'VCK5000 without batching energy': geometric_mean(cgen_b1_vck5000_datcopy_pow),
    'VCK5000 datacopy 50B energy': geometric_mean(cgen_b50_vck5000_datcopy_pow),
}
...
ax.plot(x_indexes, cgen_b1_u280_datcopy_pow, linestyle='--', marker='o', markersize=(power_marker_size), label="U280 WOB", color=colors[0], markerfacecolor='white', markeredgewidth=2 * size_multiplier, markeredgecolor=colors[0])
...
ax.plot(x_indexes, cgen_b50_u280_datcopy_pow, linestyle='-', marker='d', markersize=(power_marker_size), label="CP U280 50B", color=colors[8], markerfacecolor='white', markeredgewidth=2 * size_multiplier, markeredgecolor=colors[8])

ax.plot(x_indexes, cgen_b1_vck5000_datcopy_pow, linestyle='--', marker='o', markersize=(power_marker_size), label="VCK5 WOB", color=colors[10], markerfacecolor='white', markeredgewidth=2 * size_multiplier, markeredgecolor=colors[10])
...
ax.plot(x_indexes, cgen_b50_vck5000_datcopy_pow, linestyle='-', marker='o', markersize=(power_marker_size), label="CP VCK5 50B", color=colors[11], markerfacecolor='white', markeredgewidth=2 * size_multiplier, markeredgecolor=colors[11])
...
# Save the figure
fig.tight_layout()
plt.savefig("output/jac3d7pt_batched_power.pdf", bbox_inches='tight')
# plt.show()
