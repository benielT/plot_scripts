...
vck_cols = list(vck_df.columns[1:]) if enable_vck5000 else []
...
separator = "c" if enable_vck5000 else ""
latex_lines.append("\\begin{tabular}{l" + "c"*len(u280_cols) + separator + "c"*len(vck_cols) + "}")
...
if enable_vck5000:
    ...
    latex_lines.append("& \\multicolumn{" + str(len(u280_cols)) + "}{c}{\\textbf{U280}} \\\\")
    latex_lines.append("\\cmidrule{2-" + str(len(u280_cols)+1) + "}")
