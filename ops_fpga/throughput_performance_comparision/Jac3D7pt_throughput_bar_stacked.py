...
bar6 = ax.bar(x_indexes, h100_50b, width=bar_width, label='H100_100B', color=colors[9])
bar6 = ax.bar(x_indexes, h100_50b, width=bar_width, color='none', edgecolor='black', **iner_props)
...
# Save the figure
fig.tight_layout()
plt.savefig("output/jac3d7pt_throughput_barplot.pdf", bbox_inches='tight')
