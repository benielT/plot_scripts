...
import pandas as pd
from barplot_params import general_font_size, power_marker_size, throughput_marker_size, label_font_size, fig_size, \
...
ax.legend(handles, labels, loc=2, ncol=3, facecolor='w', framealpha=1, edgecolor='black', prop={'size': legends_font_size - 2 * size_multiplier})
...
# Save the figure
fig.tight_layout()
plt.savefig("output/jac3d7pt_throughput_barplot.png", bbox_inches='tight')
