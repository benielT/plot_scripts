...
plt.rcParams.update({'font.size': general_font_size - 2 * size_multiplier})
plt.rcParams['hatch.linewidth'] = 2
plt.rcParams['hatch.color'] = colors[1]
# plt.xticks(fontsize=general_font_size - 2 * size_multiplier)
...
# bar8 = ax2.bar(x_indexes + bar_width + energy_bar_gap + energy_bar_width, cgen_8192_u280_power, width=energy_bar_width, hatch="\\\\\\", label='U280 energy', color='white')
# bar8 = ax2.bar(x_indexes + bar_width + energy_bar_gap + energy_bar_width, cgen_8192_u280_power, width=energy_bar_width, color='none', edgecolor='black', **outer_props)
...
# Save the figure
fig.tight_layout()
plt.savefig("output/jac2d9pt_throughput_barplot_t3.pdf", bbox_inches='tight')
