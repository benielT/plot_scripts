...
ax2.plot(xticks, h100_power, linestyle='dashdot', marker='s', markersize=power_marker_size, label="H100 power", color='#fabb46', markeredgecolor='#000000')#'#92f0ab')#'#f5dc84')
...
ax2.plot(xticks, h100_50sys_power, linestyle='dashdot', marker='s', markersize=power_marker_size, label="H100-50B power", color='#fc9365', markeredgecolor='#000000')#'#92f0ab')#'#f5dc84')
