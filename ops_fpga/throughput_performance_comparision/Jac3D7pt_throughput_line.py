...
#Color Palette
colors = ['#003f5c', '#58508d', '#bc5090', '#ff6361', '#ffa600', '#34a853', '#ff7c43', '#ffa600']
# Load data
df = pd.read_csv("data/Jac3D7pt_throughput.csv")
...
ax2.plot(xticks, h100_power, linestyle='dashdot', marker='s', markersize=power_marker_size, label="H100 energy", color='#fabb46', markeredgecolor='#000000')#'#92f0ab')#'#f5dc84')
...
ax2.plot(xticks, h100_50sys_power, linestyle='dashdot', marker='s', markersize=power_marker_size, label="H100_50B energy", color='#fc9365', markeredgecolor='#000000')#'#92f0ab')#'#f5dc84')
...
ax.plot(xticks, h100_50b, linestyle='-', marker='^',markersize=throughput_marker_size, label='H100_50B', color=colors[6])
...
ax.legend(handles, labels, loc=2, ncol=2, facecolor='w', framealpha=1, edgecolor='black', prop={'size': legends_font_size - 1})
...
# Save the figure
fig.tight_layout()
plt.savefig("output/jac3d7pt_throughput_lineplot.pdf", bbox_inches='tight')
# plt.show()
