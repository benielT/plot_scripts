...
bar6 = ax.bar(x_indexes[:4] + bar_width + bar_offset, h100_10b[:4], width=bar_width, label='H100_10B', color=colors[9])
...
# bar8 = ax2.bar(x_indexes[:4] + bar_width + energy_bar_gap, h100_1sys_power[:4], width=energy_bar_width, hatch="...", label='H100_1B energy', color='white')
# bar8 = ax2.bar(x_indexes[:4] + bar_width + energy_bar_gap, h100_1sys_power[:4], width=energy_bar_width, color='none', edgecolor='black', **outer_props)


# bar9 = ax2.bar(x_indexes + bar_width + energy_bar_gap, h100_10sys_power, width=energy_bar_width, label='H100_10B energy', color=colors[10])
# bar9 = ax2.bar(x_indexes + bar_width + energy_bar_gap, h100_10sys_power, width=energy_bar_width, color='none', edgecolor='black', **outer_props)

# plt.rcParams['hatch.color'] = colors[10]
# bar8 = ax2.bar(x_indexes[4:] + bar_width + energy_bar_gap, h100_1sys_power[4:], width=energy_bar_width, hatch="...", color='white')
# bar8 = ax2.bar(x_indexes[4:] + bar_width + energy_bar_gap, h100_1sys_power[4:], width=energy_bar_width, color='none', edgecolor='black', **outer_props)
...
ax2.plot(x_indexes  + bar_width, h100_1sys_power, linestyle='dashdot', marker='o', markersize=power_marker_size, label="H100 energy", color='none', markerfacecolor='white', markeredgewidth=3.5 * size_multiplier, markeredgecolor=colors[10])
...
# Save the figure
fig.tight_layout()
plt.savefig("output/diffusion3d7pt_throughput_barplot.png", bbox_inches='tight')
