...
bar6 = ax.bar(x_indexes[:4], h100_10b[:4], width=bar_width, label='H100_10B', color=colors[9])
bar6 = ax.bar(x_indexes[:4], h100_10b[:4], width=bar_width, color='none', edgecolor='black', **iner_props)
...
bar6 = ax.bar(x_indexes[4:], h100_10b[4:], width=bar_width, color=colors[9])
bar6 = ax.bar(x_indexes[4:], h100_10b[4:], width=bar_width, color='none', edgecolor='black', **iner_props)
...
# Save the figure
fig.tight_layout()
plt.savefig("output/diffusion3d7pt_throughput_barplot.pdf", bbox_inches='tight')
