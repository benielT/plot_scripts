...
#Color Palette
colors = ['#003f5c', '#58508d', '#bc5090', '#ff6361', '#ffa600', '#34a853', '#d9b3e6']
# Load data
...
cgen_l_u280 = df["codegen_L_u280"]
cgen_m_u280 = df["codegen_M_u280"]
...
ax.plot(xticks, cgen_l_u280, linestyle='-', marker='o', label='c_loop_u280', color=colors[1])
ax.plot(xticks, cgen_m_u280, linestyle='-', marker='o', label='c_mem_u280', color=colors[6])
...
ax.plot(xticks, h100_10b, linestyle='--', marker='^', label='h100_10b', color=colors[5])
