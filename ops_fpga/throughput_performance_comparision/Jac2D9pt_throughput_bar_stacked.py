...
bar2 = ax.bar(x_indexes - 2*bar_width, cgen_4096_u280, width=bar_width, label='c_U280', color=colors[5])
bar2 = ax.bar(x_indexes - 2*bar_width, cgen_4096_u280, width=bar_width, color='none', edgecolor='black', **iner_props)
...
# bar3 = ax.bar(x_indexes[:4] - bar_width, cgen_8192_u280[:4], width=bar_width, color='none', edgecolor='black', **iner_props)
...
bar3 = ax.bar(x_indexes[7:] - 2*bar_width, cgen_8192_u280[7:], width=bar_width,  color=colors[5])
# bar3 = ax.bar(x_indexes[:4] - bar_width, cgen_8192_u280[:4], width=bar_width, color='none', edgecolor='white', **outer_props)
bar3 = ax.bar(x_indexes[7:] - 2*bar_width, cgen_8192_u280[7:], width=bar_width, color='none', edgecolor='black', **iner_props)
...
bar8 = ax2.bar(x_indexes + bar_width + energy_bar_gap, cgen_8192_u280_power, width=energy_bar_width, hatch="\\\\\\", label='U280 energy', color='white')
bar8 = ax2.bar(x_indexes + bar_width + energy_bar_gap, cgen_8192_u280_power, width=energy_bar_width, color='none', edgecolor='black', **outer_props)
