...
# ax2 = ax.twinx()
line1 = ax.plot(u280_300_x[1:], u280_p54_300_y[1:], label="54PE x=300")
line2 = ax.plot(u280_300_x[1:], u280_p60_300_y[1:], label="60PE x=300")
line3 = ax.plot(u280_400_x, u280_p54_400_y, label="54PE x=400")
line4 = ax.plot(u280_400_x, u280_p60_400_y, label="60PE x=400")
