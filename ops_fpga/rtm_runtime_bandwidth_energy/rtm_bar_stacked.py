...
bar2 = ax.bar(x_indexes - bar_width + bar_offset, cgen_u55c, width=bar_width, label='c_U55c', color=colors[5])
bar2 = ax.bar(x_indexes - bar_width + bar_offset, cgen_u55c, width=bar_width, color='none', edgecolor='black', **iner_props)
...
bar6 = ax.bar(x_indexes + bar_width + bar_offset, h100_1b, width=bar_width, color='none', edgecolor='black', **iner_props)
